...
const AdminPanel = () => {
    ...
    <>
     ...
     /*    <div className="flex flex-col w-full justify-center items-center min-h-screen bg-gray-100">
            
          
            
            <div className="mb-4">
            <h1 className="text-3xl mb-6 text-center text-gray-800">Hesap Ekle</h1>
              ...
              <input
                ...
                required
              />
              <button type='submit' disabled={loadinguser} className='disabled:opacity-50 bg-blue-500 rounded-2xl px-4 py-2 text-white w-max'>Hesap Oluştur</button>
              </form>
          
            </div>
            
            <div className="mb-4">
            <h1 className="text-3xl mb-6 text-center text-gray-800">Hesap Sil</h1>
              <form onClick={Createuser} className='flex flex-col justify-center items-center gap-5'>
              <label className="block text-gray-700 font-semibold">Email:</label>
              <input
                type="email"
                ...
                required
              />
              <button type='submit' disabled={loadinguser} className='disabled:opacity-50 bg-red-500 rounded-2xl px-4 py-2 text-white w-max'>Hesap Sil</button>
              </form>
